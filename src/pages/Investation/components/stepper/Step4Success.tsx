...
const Step4Success = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center text-center py-4">
      ...
      <div className="w-32 h-32 mb-6 flex items-center justify-center bg-[#81C784]/20 rounded-full text-primary">
        <HiCheckBadge className="w-20 h-20" />
      </div>
      ...
      <button 
        ...
        className="w-full py-3 bg-primary text-white rounded-full text-sm font-semibold hover:bg-[#144818] transition-colors cursor-pointer"
      >
        Ke Dashboard
      </button>
    </div>
