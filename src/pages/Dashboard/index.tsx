        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white p-6 rounded-3xl shadow-sm">
            <div className="flex justify-between items-start mb-4">
              <p className="text-gray-400 text-xs font-bold uppercase">Total Pendapatan</p>
              <HiOutlineTrendingUp className="text-primary text-xl"/>
            </div>
            <p className="text-2xl font-bold text-primary">Rp. 600.000</p>
          </div>
          <div className="bg-white p-6 rounded-3xl shadow-sm">
            <div className="flex justify-between items-start mb-4">
            ...
            <p className="text-2xl font-bold text-red-600">Rp. 180.000</p>
          </div>
        </div>
      </div>
    </div>
